...
public class Test2_2 extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<hr/>");
		out.print("<p><a href='"+request.getContextPath()+"/study/1113/test2.jsp'>돌아가기</a></p>");
		*/
		
		// 서버에서 get방식으로의 전송방법
		response.sendRedirect(request.getContextPath()+"/study/1113/test2Ok.jsp?hakbun="+hakbun+"&name="+name+"&kor="+kor+"&eng="+eng+"&mat="+mat+"&soc="+soc+"&sci="+sci+"&tot="+tot+"&avg="+avg+"&grade="+grade);
