...
<head>
	...
	else if (msg == "guInputNo") msg = "방명록 글등록 실패";
	...
	else if(msg == "loginNo") msg = val+ "님 로그인 실패.";
	else if(msg == "memLogoutOk") msg = val+ "님 로그아웃 되셧습니다.";
	else if(msg == "idCheckNo") msg = "중복된 아이디 입니다.";
	else if(msg == "nickCheckNo") msg = "중복된 아이디 입니다.";
	else if(msg == "memJoinOk") msg = "회원가입 성공하셧습니다.";
	else if(msg == "memJoinNo") msg = "회원가입 실패하셧습니다.";
	else if(msg == "passwordNo") msg = "비밀번호를 확인하세요~.";
	else if(msg == "passwordOk") msg = "비밀번호를 변경하엿습니다~.";
	else if(msg == "passwordOkNo") msg = "비밀번호를 변경실패하엿습니다~.";
	...
	else if(msg == "boInputOk") msg = "게시판에 글을 등록하셨습니다.";
	else if(msg == "boInputNo") msg = "게시판에 글등록을 실패하셨습니다.";
