...
<div class="container">
	<form name="myform" method="post" action="${ctp}/guInputOk.gu" class="was-validated">
      ...
      <div class="valid-feedback">승인!!</div>
      <div class="invalid-feedback">이름을 입력은 필수입니다.</div>
    </div>
		<div class="form-group">
      ...
      <input type="text" class="form-control" name="homePage" id="homePage" value="http://" placeholder="홈페이지 주소를입력하세요" />
      <div class="valid-feedback"></div>
     
    </div>
		<div class="form-group">
      <label for="content">방문소감</label>
      <textarea rows="5" class="form-control" name="content" id="cotent"  required /></textarea>
      <div class="valid-feedback">승인!!</div>
