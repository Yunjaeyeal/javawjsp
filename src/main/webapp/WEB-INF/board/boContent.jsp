		...
		<tr>
			...
			<td colspan="4" class="text-center">
				...
				<c:if test="${flag != 'search' }">
					...
					<input type="button" value="수정하기" onclick="location.href='${ctp}/boUpdate.bo?idx=${vo.idx}&pageSize=${pageSize}&pag=${pag}';" class="btn btn-secondary"/>
					<input type="button" value="삭제하기" onclick="boDelCheck()" class="btn btn-secondary"/>
					</c:if>
				</c:if>
			</td>
		</tr>
	...
	<table class="table text-center">
		<tr>
			<td style="width:85%" class="text-left">
				글내용 : 
				<textarea row="4" name="content" id="content" class="form-control"></textarea>
			</td>
			<td style="width:15%">
				<br/>
				<p>작성 : ${sNickName}</p>
