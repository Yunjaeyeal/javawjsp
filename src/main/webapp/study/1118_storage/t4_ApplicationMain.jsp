...
<div class="container">
	...
	<div class="row mb-3">
	<div class="col"><input type="submit" value="Application저장(서버기동후 처음 1회만 수행할것)" class="btn btn-success form-control"></a></div>
	<div class="col"><a href="t4_ApplicationCheck.jsp" class="btn btn-danger form-control">Application 확인</a></div>
	</div>
	<div class="row mb-3">
	<div class="col"><a href="t4_ApplicationDelNick.jsp" class="btn btn-primary form-control">Application(닉네임) 삭제</a></div>	
	</div>
	</div>
	</form>
</div>
